...
var END = 'end';
exports.END = END;
var MAX_RANDOM_DELAY_FOR_MEETING_INFO = 3 * 60 * 1000;
exports.MAX_RANDOM_DELAY_FOR_MEETING_INFO = MAX_RANDOM_DELAY_FOR_MEETING_INFO;
...
var _MOVE_MEDIA_ = 'MOVE_MEDIA';

// *********** PARTICIPANT DELTAS ***********
exports._MOVE_MEDIA_ = _MOVE_MEDIA_;
...
var CONVERSATION_SERVICE = 'identityLookup';
exports.CONVERSATION_SERVICE = CONVERSATION_SERVICE;
var WBXAPPAPI_SERVICE = 'webex-appapi-service';

// ******************* ARRAYS ********************
// Please alphabetize
exports.WBXAPPAPI_SERVICE = WBXAPPAPI_SERVICE;
...
var LAYOUT_TYPES = ['Single', 'Equal', 'ActivePresence', 'Prominent', 'OnePlusN'];
...
var UUID_REG = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
...
var REMOTE_VIDEO_CONSTRAINTS = {
  MAX_FS: (_MAX_FS = {}, (0, _defineProperty2.default)(_MAX_FS, QUALITY_LEVELS.LOW, 1620), (0, _defineProperty2.default)(_MAX_FS, QUALITY_LEVELS.MEDIUM, 3600), (0, _defineProperty2.default)(_MAX_FS, QUALITY_LEVELS.HIGH, 8192), _MAX_FS)
};

/*
 *  mqa Interval for sending stats metrics
 */
exports.REMOTE_VIDEO_CONSTRAINTS = REMOTE_VIDEO_CONSTRAINTS;
...
exports.BNR_STATUS = BNR_STATUS;
var EMBEDDED_APP_TYPES = {
  SLIDO: 'SLIDO',
  OTHER: 'OTHER'
};
exports.EMBEDDED_APP_TYPES = EMBEDDED_APP_TYPES;
